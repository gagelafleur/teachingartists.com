 ...
 * );
 */
$config['recipients'] = 'ddavis@teachingartists.com';
 ...
 * $config['from'] = '%email%';
 */
$config['from'] = 'ddavis@teachingartists.com';
...
/**
 * Configure the organization element
 * Filters: Trim
 * Validators: Required
 */
$name = new Quform_Element('organization', 'Organization');
$name->addFilter('trim');
$form->addElement($name);

/**
 * Configure the web_address element
 * Filters: Trim
 * Validators: Required
 */
$name = new Quform_Element('web_address', 'Web Address');
$name->addFilter('trim');
$form->addElement($name);

/**
 * Configure the address_1 element
 * Filters: Trim
 * Validators: Required
 */
$name = new Quform_Element('address_1', 'Address 1');
$name->addFilter('trim');
$form->addElement($name);

/**
 * Configure the address_2 element
 * Filters: Trim
 * Validators: Required
 */
$name = new Quform_Element('address_2', 'Address 2');
$name->addFilter('trim');
$form->addElement($name);
 ...
 * Validators: Required
 */
$name = new Quform_Element('city', 'City');
$name->addFilter('trim');
$form->addElement($name);
 ...
 * Validators: Required
 */
$name = new Quform_Element('state', 'State');
$name->addFilter('trim');
$form->addElement($name);
 ...
 * Validators: Required
 */
$name = new Quform_Element('zip', 'Zip');
$name->addFilter('trim');
$form->addElement($name);
 ...
 * Validators: Required
 */
$name = new Quform_Element('phone', 'Phone');
$name->addFilter('trim');
$name->addValidator('required');
$form->addElement($name);

$subject = new Quform_Element('subject', 'How did find us');
